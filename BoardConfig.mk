...
# Kernel
TARGET_PREBUILT_KERNEL := device/samsung/m21/prebuilt/Image
TARGET_PREBUILT_DTB := device/samsung/m21/prebuilt/dtb
BOARD_PREBUILT_DTBOIMAGE := device/samsung/m21/prebuilt/recoverydtbo
...
BOARD_MKBOOTIMG_ARGS += --header_version $(BOARD_BOOT_HEADER_VERSION) --pagesize $(BOARD_KERNEL_PAGESIZE) --board "SRPSL26A003RU"
BOARD_MKBOOTIMG_ARGS += --dtb $(TARGET_PREBUILT_DTB) --dtb_offset $(BOARD_DTB_OFFSET)
BOARD_CUSTOM_BOOTIMG_MK := device/samsung/m21/bootimg.mk
